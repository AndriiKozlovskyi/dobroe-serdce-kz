export default {
  ...
  about: {
    ...
    intro: 'Қарттар пансионатын таңдағанда шынайы қамқорлық бар орынды табу маңызды. «Доброе сердце» пансионатында әр адам әрқашан бірінші орында.',
    outro: 'Қарттар үйі туралы көзқарасыңызды өзгерту үшін пансионатқа келіп, тұрғындармен және қызметкерлермен жеке сөйлесуге шақырамыз.',
  ...
  services: {
    ...
    items: [
      ...
      { title: 'Дәрі-дәрмек бақылауы', description: 'Дәрігер тағайындаған дәрілерді уақтылы беру және қабылдауды күнделікті бақылау.' },
